...
export interface ICourseService {
  create(authUser: AuthUserDTO, data: CreateCourseDTO): Promise<CourseResponseDTO>;

  findById(authUser: AuthUserDTO, courseId: string): Promise<CourseResponseDTO | null>;
